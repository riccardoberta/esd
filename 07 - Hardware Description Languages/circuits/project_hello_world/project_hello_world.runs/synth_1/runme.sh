...
HD_PWD='C:/Users/riccardo.berta/Documents/ESD/07 - Hardware Description Languages/project_hello_world/project_hello_world.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sillyfunction.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sillyfunction.tcl
